...
class Employee:
    ...
    def department_id(self, department_id):
        if type(department_id) is int and Department.find_by_id(department_id):
            self._department_id = department_id # The department_id setter method checks to ensure I am assigning a valid department by checking the foreign key reference in the database.
        else:
            raise ValueError(
